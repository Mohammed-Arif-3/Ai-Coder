...
const createPrompt = (inputLanguage, outputLanguage, inputCode) => {
  if (inputLanguage === 'Natural Language') {
    return endent`
    You are an expert programmer in all programming languages. Translate the natural language to "${outputLanguage} and also print the output of the code below it" . Do not include \`\`\`.
    ...
    return endent`
      You are an expert programmer in all programming languages. Translate the "${inputLanguage}" code to "${outputLanguage}" and also print the output of the code below it". Do not include \`\`\`.
